...
public class ActivityA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modelList.add(new GeneralModel(R.drawable.ic_person, "Anthony Joshua", "Boxer", "Born 20th, Sept. 1986"));
        modelList.add(new GeneralModel(R.drawable.ic_person, "Anthony Joshua", "Boxer", "Born 20th, Sept. 2019"));
        modelList.add(new GeneralModel(R.drawable.ic_person, "Anthony Joshua", "Boxer", "Born 20th, Sept. 2019"));
        modelList.add(new GeneralModel(R.drawable.ic_person, "Anthony Joshua", "Boxer", "Born 20th, Sept. 2019"));
        modelList.add(new GeneralModel(R.drawable.ic_person, "Anthony Joshua", "Boxer", "Born 20th, Sept. 2019"));
        modelList.add(new GeneralModel(R.drawable.ic_person, "Anthony Joshua", "Boxer", "Born 20th, Sept. 2019"));
